...
class BookingTest1Chrome(unittest.TestCase):
    def setUp(self):
    ...
    def test_calendar(self):
        ...
        cal_check = driver.find_element_by_class_name('xp-calendar')
...
class BookingTest2Chrome(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()
        self.driver.get('http://booking.com')
    ...
    def test_click(self):
        ...
        calendar = driver.find_element_by_class_name('c2-calendar')
        self.assertTrue(calendar is not None)

    def tearDown(self):
        self.driver.quit()

class BookingTest3Chrome(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()
        self.driver.get('http://booking.com')
...
class BookingTest4Chrome(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()
	self.driver.get('http://booking.com')
